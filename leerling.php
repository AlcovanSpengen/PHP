...
$voornaam = $achternaam = $email = $telefoonnummer = $adres = $woonplaats = $opleiding = $opmerkingen = "";
...
?>
    <section class="aanmeldpagina">
           <form id="contact-form" action="form2.php" method="post">
               <h1>Aanmeldformulier Leerling</h1>
                    <div class="form">
                    ...
                    <div class="form">
                        <input type="text" name="opleiding" placeholder="Vul hier uw hoogst afgeronde opleiding in" required="required" class="form-control">
                    </div>
                    <div class="form">
